...
public class EqualDamageDistributionAlgorithm implements IDamageDistributionAlgorithm {
    ...
    private static final Method GET_DAMAGE_AFTER_MAGIC_ABSORB_METHOD = ObfuscationReflectionHelper.findMethod(LivingEntity.class, "getDamageAfterMagicAbsorb", DamageSource.class, float.class);
